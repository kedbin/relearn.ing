      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {buckets.map((bucket, idx) => (
            <motion.div
              key={bucket.title}
              className="group bg-gradient-to-br from-slate-900/60 to-slate-900/40 border border-slate-800/80 p-7 rounded-2xl hover:border-red-500/50 hover:shadow-xl hover:shadow-red-500/10 hover:-translate-y-1 transition-all duration-300 h-full flex flex-col"
