      ...
      {filteredEntries.length > 0 ? (
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredEntries.map((entry) => {
             ...
             return (
              <article key={entry.id} className={`p-6 rounded-2xl bg-slate-900/60 border flex flex-col justify-between group transition-all duration-300 ${cardStyle}`}>
                <div>
                ...
                <a
                  ...
                  className="flex items-center gap-2 text-sm font-medium text-slate-400 group-hover:text-brand-300 transition-colors"
                >
